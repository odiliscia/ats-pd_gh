ats_sinnoi~ is an external object to be used in the Pure Data environment (Miller Puckette et al) .

Except where otherwise noted, ats_noisy~ is Copyright 2012 by Pablo Di Liscia.
